                ...
                <div class="bg-yellow-50 rounded-lg shadow-sm p-6 border-l-4 border-yellow-400">
                    ...
                    <ul class="space-y-2 text-xs text-gray-700">
                        <li class="flex items-start">
                            ...
                            <span>Cuti tahunan harus diajukan minimal <strong>H+3</strong></span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-yellow-600 mr-2">•</span>
                            <span>Cuti sakit bisa diajukan <strong>mulai hari ini (H-0)</strong></span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-yellow-600 mr-2">•</span>
                            <span>Cuti sakit <strong>wajib</strong> melampirkan surat dokter</span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-yellow-600 mr-2">•</span>
                            <span>Hari Sabtu dan Minggu tidak dihitung</span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-yellow-600 mr-2">•</span>
                            <span>Maksimal 1 pengajuan pending</span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-yellow-600 mr-2">•</span>
                            <span>Pengajuan harus disetujui Ketua Divisi & HRD</span>
                        </li>
                    </ul>
                </div>
            </div>
