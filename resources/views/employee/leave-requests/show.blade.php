        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <x-leave.actions-sidebar 
                    ...
                    :backRoute="route('employee.leave-requests.index')"
                    :downloadRequestRoute="route('employee.leave-requests.download-request', $leaveRequest)"
                    :downloadApprovalRoute="route('employee.leave-requests.download-approval', $leaveRequest)"
